create role web with password 'web';
...
insert into utilisateur(nom,motdepasse,acces) values('utilisateur','123456',0);
...
insert into info(titre,contenu,idutilisateur) VALUES('ChatGPT','chatGPT est le meuilleur, disent les amateurs',1);  
