            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="agency-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="/homeFO">Home</a></li>
                        <li><a href="/addInfoFO">Ajouter Information</a></li>
                                    ...
                                    <div class="col-md-8">
                                        <div class="respond">
                                            ...
                                            <form class="form-horizontal" action="/createInfoFO" method="post" enctype="multipart/form-data">
                                                ...
                                                <textarea class="form-control form-control-comment" type="text" placeholder="Contenu" name="contenu" required></textarea>
